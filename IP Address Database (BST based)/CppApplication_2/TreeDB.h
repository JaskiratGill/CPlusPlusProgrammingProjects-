...
private:
   ...
   TreeNode* insertion(DBentry* p, TreeNode* r);
   int activeCounter(TreeNode* treeRoot) const;
   TreeNode* LargestNode(TreeNode* nodeEntered);
   const void FullTreePrinter(const TreeNode* ptr, ostream &out) const ;
